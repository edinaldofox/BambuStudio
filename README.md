...
For reproducible builds without global Boost, TBB, or CURL installations, see
[dependency builds](docs/dependency-builds.md). The dependency prefix is built
per operating system and architecture, then bundled with the final package.
